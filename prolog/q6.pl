...
assign_projects(List1,Q,L1) :-  (Q>0, [X|L] = List1,write('Project :'),nl, assign(X,L1),write(L1),nl,G is L1 ,Q1 is Q - 1) -> ( [X|L]=List1, Q1 is Q - 1,assign_projects(L,Q1,G));
                                (  [X|L] = List1, Q1 is Q -1 , assign_projects(L,Q1,G)).
