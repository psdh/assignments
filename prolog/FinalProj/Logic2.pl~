...
duration_before_which_president_must_return_bill :- write('10 days excluding sundays \n'). 
...
% function to print the duties of congress as it is.
...
check_bill(V1,V2,Days) :- V1 > 50, V2 > 50,Days > 10.
check_bill(V1,V2,Days,ANS) :- V1 > 50, V2 > 50,Days =< 10, ANS = passed.
check_bill(V1,V2,Days,ANS,H1,H2) :- V1 > 50, V2 > 50,(Days > 10 ; ANS = passed),check_bill(V1,V2,H1,H2).
check_bill(V1,V2,H1,H2) :- V1 > 50, V2 > 50, H1 > 67, H2 > 67.
